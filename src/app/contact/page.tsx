...
const ContactPage: React.FC = () => {
  return (
    <div>
     ...
     {/* Contact Section */}
<div className="container mx-auto py-16 px-4 lg:px-0 bg-gradient-to-b from-gray-100 to-gray-200">
  <div className="flex flex-wrap -mx-4">
    ...
    <div className="w-full md:w-1/2 px-4 mb-12 md:mb-0">
      ...
      <form className="bg-white shadow-2xl p-10 rounded-2xl space-y-8 transform transition-all duration-500 hover:shadow-3xl hover:scale-105">
